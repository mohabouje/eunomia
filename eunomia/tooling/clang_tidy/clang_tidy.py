...
class ClangTidy(AbstractTool):

    _default_path: str = os.path.join(os.path.dirname(__file__), 'template/clang-tidy.mustache')
    _default_filename: str = '.clang-tidy'
    _identifier: str = 'clang-tidy'
    ...
    def setup(self, configuration: Dict[str, Any], destination: str) -> None:
        ...
        logger.info(f'Exporting a configuration for clang-tidy in {file}')
